...
#pragma warning restore 618
    ...
    internal class PublishedProperty : PublishedPropertyBase
    {
        ...
        public override bool HasValue
        {
            get
            {
                return this.dataValue != null
                       && (!(this.dataValue is string)
                           || !string.IsNullOrWhiteSpace((string)this.dataValue));
            }
        }
        ...
        public override object Value
        {
            get
            {
                // Don't convert if the dataValue is null.
                // Because this goes wrong with the MultipleTextStringValueConverter.
                // See http://issues.umbraco.org/issue/U4-8510.
